...
\begin{bbawslide}{Collaboration}
  ...
  \centerslidestrue%
  \begin{itemize}
    \item OCR-D Ground Truth Guidelines
    \begin{itemize}\small
      \item Format documentation of the existing OCR-D Ground Truth (GT)
      \item Instructions for the GT creation, which is used within the OCR-D project as also outside of it (community use)
      \item Validation of the Ground Truth and transfer of existing transcriptions for GT
			\item Support for the set up of a Ground Truth repository for print publications and handwritten documents
    \end{itemize}
		\end{itemize}
    \item Transkribus User Documentation : A Proposal
    \begin{itemize}
			\item First step: change the documentation format from Wiki to DITA
			\item Second step: organize the colloboration writing the handbook in the same way as libreOffice
			\item Thrid step: build and organize the handbook repository (e.g. github)
    \end{itemize}
  \end{itemize}
\end{bbawslide}
